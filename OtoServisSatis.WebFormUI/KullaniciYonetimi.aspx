...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>   
        ...
        <asp:GridView ID="dgvKullanicilar" runat="server" Height="136px" Width="343px" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="dgvKullanicilar_SelectedIndexChanged1">
                ...
                <td>
                    <table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnKaydet" runat="server" Height="26px" OnClick="btnEkle_Click" Text="Kaydet" />
